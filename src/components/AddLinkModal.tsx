      ...
      >
        <div className="flex items-center justify-between px-6 py-4.5 bg-slate-900 text-white border-b border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-base leading-tight">Tambah Tautan Baru</h3>
              <p className="text-xs text-slate-300">Input link satu per satu atau multi-baris sekaligus</p>
            </div>
          </div>
          <button
